...
function processDescription(allowedTypes) {
  ...
  function assertNoUnusedWords() {
    ...
    if (pendingWords.length) {
      throw new Error("The description `" + oldDescription.join(WORD_DELIM) + "` could not be understood. The following words were found without being bound to a type: " + pendingWords.join(", "));
    }
  }
